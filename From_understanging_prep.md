...
Nota importante: Tenga en cuenta que no se espera que sepa programar en Python. El código siguiente tiene como objetivo ilustrar la etapa
de recopilación de datos, por lo que no hay ningún problema si no comprende las líneas de código individuales. En este certificado habrá un 
curso completo sobre programación en Python, Python para ciencia de datos, que le enseñará a programar en Python si decide completar este certificado.

Obtenga la versión de Python instalada.
...
Descargue la biblioteca y las dependencias que necesitaremos para ejecutar este laboratorio.
...
Descargue los datos del servidor IBM y léalos en un marco de datos de pandas.
...
Obtenga las dimensiones del marco de datos.
...
Nuestro conjunto de datos consta de 57.691 recetas. Cada fila representa una receta y, para cada receta, se documenta el tipo de cocina <br> 
correspondiente y si la receta contiene o no 384 ingredientes, comenzando con almendras y terminando con calabacín.
...
- salsa de soja
- wasabi
- un poco de pescado/verduras

Verifiquemos que estos ingredientes existan en nuestro marco de datos:
...
- El arroz existe como arroz.
- El wasabi existe como wasabi.
- La soja existe como salsa de soja.

Por lo tanto, si una receta contiene los tres ingredientes: arroz, wasabi y salsa de soja, ¡podemos decir con seguridad que la receta es una cocina **japonesa**! ¡Tengamos esto en cuenta!
...
En esta sección, prepararemos los datos para la siguiente etapa de la metodología de ciencia de datos, que es el modelado. Esta etapa implica explorar los datos en profundidad y asegurarnos de que estén en el formato correcto para el algoritmo de aprendizaje automático que seleccionamos en la etapa de enfoque analítico, que son los árboles de decisión.
...
1. La columna de cocina está etiquetada como País, lo cual es incorrecto.
2. Los nombres de las cocinas no son consistentes, ya que no todas comienzan con la primera letra en mayúscula.
3. Algunas cocinas están duplicadas como variación del nombre del país, como Vietnam y vietnamita.
4. Algunas cocinas tienen muy pocas recetas.

Arreglar el nombre de la columna que muestra la cocina.
...
Poner todos los nombres de las cocinas en minúsculas.
...
Hacer que los nombres de las cocinas sean coherentes.
...
Eliminar cocinas con < 50 recetas.
...
Convierte todos los Sí en 1 y los No en 0
...
#### Analicemos un poco más los datos para conocerlos mejor y anotar cualquier observación preliminar interesante.

Ejecute la siguiente celda para obtener las recetas que contienen arroz y soja y wasabi y algas.
...
En base a los resultados del código anterior, ¿podemos clasificar todas las recetas que contienen arroz, soja, wasabi y algas como recetas japonesas? ¿Por qué?

Tu respuesta:

<details><summary>Haga clic aquí para obtener una solución</summary>

```python
#La respuesta correcta es:

No, porque otras recetas como las asiáticas y las de Asia oriental también contienen estos ingredientes.
```

</details>

Contemos los ingredientes de todas las recetas.
...
Ahora tenemos un marco de datos de ingredientes y sus cantidades totales en todas las recetas. Ordenemos este marco de datos en orden descendente.
...
#### ¿Cuáles son los 3 ingredientes más populares?
...
Sin embargo, tenga en cuenta que hay un problema con la tabla anterior. Hay aproximadamente 40 000 recetas estadounidenses en nuestro conjunto de datos, lo que significa que los datos están sesgados a favor de los ingredientes estadounidenses.

**Por lo tanto**, calculemos un resumen más objetivo de los ingredientes observando los ingredientes por cocina.

#### Vamos a crear un _perfil_ para cada cocina.

En otras palabras, vamos a intentar averiguar qué ingredientes suelen utilizar los chinos y qué es la comida **canadiense**, por ejemplo.
...
Como se muestra arriba, acabamos de crear un marco de datos donde cada fila es una cocina y cada columna (excepto la primera columna) es un ingrediente, y los valores de las filas representan el porcentaje de cada ingrediente en la cocina correspondiente.

**Por ejemplo**:

- _almendra_ está presente en el 15,65 % de todas las recetas **africanas**.
- _mantequilla_ está presente en el 38,11 % de todas las recetas **canadienses**.

Imprimamos el perfil de cada cocina mostrando los cuatro ingredientes principales de cada una.
...
¡En este punto, sentimos que hemos entendido bien los datos y que están listos y en el formato correcto para el modelado!
